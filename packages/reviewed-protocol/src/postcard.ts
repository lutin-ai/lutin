// Minimal postcard subset shared with the scratchpad workflow's wire
// module. Standard flavour: LEB128 varints, 1-byte bool, length-prefixed
// strings/Vec, 1-byte Option tag, varint(u32) discriminant for enums,
// fields in declared order for structs.
